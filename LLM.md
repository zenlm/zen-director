# zen-director — AI Knowledge Base

**Project**: zen-director
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-director
**HuggingFace**: https://huggingface.co/zenlm/zen-director
**Last Updated**: 2026-02-27

## Overview

zen-director is part of the Zen AI model family by Hanzo AI / Zen LM.
